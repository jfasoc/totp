...
class TestGenerateTotp:
    ...
    def test_generate_totp(self, secret: str) -> None:
...
class TestFindTotpUrl:
    ...
    def test_find_totp_url_single(self, secret: str) -> None:
...
class TestGetTotpFromUrl:
    ...
    def test_get_totp_from_url_valid(self, secret: str) -> None:
    ...
    def test_get_totp_from_url_all_params(self, secret: str) -> None:
    ...
    def test_get_totp_from_url_hotp(self, secret: str) -> None:
